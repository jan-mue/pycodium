        ...
        rx.el.div(
            rx.cond(
                ...
                monaco(
                    ...
                    # LSP response state vars
                    completion_response=EditorState.completion_response,
                    hover_info=EditorState.hover_info,
                    signature_help_response=EditorState.signature_help_response,
                    reference_response=EditorState.reference_response,
                    rename_response=EditorState.rename_response,
                    prepare_rename_response=EditorState.prepare_rename_response,
                    ...
                    on_signature_help_request=EditorState.handle_signature_help_request,
                    on_reference_request=EditorState.handle_reference_request,
                    on_prepare_rename_request=EditorState.handle_prepare_rename_request,
                    on_rename_request=EditorState.handle_rename_request,
                ),
            ),
            class_name="flex-1",
        ),
